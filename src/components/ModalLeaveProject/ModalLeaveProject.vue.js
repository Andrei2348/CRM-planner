...
export * from './ModalLeaveProject.js';
export { default } from './ModalLeaveProject.js';
;
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({ ...{ onClick: (__VLS_ctx.suggestLeaveHandler) }, ...{ class: ("modal__button-suggest") }, });
...
;
let __VLS_self;
//# sourceMappingURL=ModalLeaveProject.vue.js.map