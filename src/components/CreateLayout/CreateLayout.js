import { defineComponent, watchEffect, defineAsyncComponent, shallowRef, onBeforeMount, onBeforeUnmount } from 'vue';
...
export default defineComponent({
    ...
    setup() {
        ...
        const currentCreateComponent = shallowRef(null);
        watchEffect(() => {
            const componentName = uxuiStore.getCreatePanelName;
            if (componentName) {
                currentCreateComponent.value = defineAsyncComponent(() => import(`@/components/${componentName}/${componentName}.vue`));
            }
            else {
